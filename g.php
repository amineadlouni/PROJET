...
<html>
	...
	<body class="is-preload">
		...
		<!-- Heading -->
		<div id="heading" style="background-image:url(./images/<?PHP echo $data['image'];?>)">
			...
			<section id="main" class="wrapper" style="background-color: rgb(41, 40, 40);">
				<div class="inner">
					<div class="content" style="background-color: rgb(233, 233, 233);">
						...
						<section>
							<table ><tr>
								<td colspan="2"><img src="images/GT3.jpg"width="100%" height="500px" alt="" /></td>
								</tr>
								<tr >
								<td><img src="images/GT32.jpg" width="100%" height="350" alt="" /></td>
								<td><img src="images/GT33-25.jpg"  width="100%"  height="350" alt="" /></td>
								</tr>
...
<input type="hidden" name="car" value="10">
	<br/>
<h3 align="center"> <b>Le prix est relatif aux options choisies !</b></h3><h4 align="center">à partir de <b>1.000.000 dh</b> , jusqu'à <b>1.030.000  dh</b></h4> 
 <hr/>
