...
<html>
	<head>
		<title>VOLKSWAGEN PASSAT 2020</title>
		<meta charset="utf-8" />
			...
			<section id="main" class="wrapper" style="background-color: rgb(41, 40, 40);">
				<div class="inner">
					<div class="content" style="background-color: rgb(233, 233, 233);">
						...
						<section>
							<table ><tr>
								<td colspan="2"><img src="images/pst2.jpg" width="100%" height="500px" alt="" /></td>
								</tr>
								<tr >
								<td width="50%"><img src="images/pst3.jpg" width="100%"  alt="" /></td>
								<td width="50%"><img src="images/pst1.jpg" width="100%"  alt="" /></td>
								</tr>
								</table>
						</section>
...
<table >	
	...
	<tr height="100px">
			...
			<td >	<select name="version" >
							<option value="1.5 TSI GLI S">1.5 TSI GLI S   </option>
	...
	<tr height="180px"><td><b>Couleurs Disponibles :</b></td>
								...
								<td><input type="radio" id="radio-alpha" name="coul" value="Bleue" checked>
									...
									<input type="radio" id="radio-beta" name="coul" value="Grise" >
												<label for="radio-beta">Grise</label><br>
									<input type="radio" id="radio-gamma" name="coul" value="Blanche">
												<label for="radio-gamma">Blanche</label></td>	
	</tr>
									<tr >
										<td></td>
